                    ...
                    return (
                        ...
                        {/* make sure card height takes up entire height */}
                            <Card style={{ "height": "100%" }}>
                                ...
                                <Card.Body>
                                    <Card.Title>{value.generic_name}</Card.Title>
                                    <Card.Text>{value.name}</Card.Text>
                                    <Card.Text>{value.price ?? "Untracked"}</Card.Text>
                                    {/* <Button variant="primary">Add to Watchlist</Button> */}
                                </Card.Body>
                                <Card.Footer><Button variant="primary" onClick={(event) => {handleWatchlistAdd(value, event)}}>Add to Watchlist</Button></Card.Footer>
                            </Card>
                        </Col>
                    );
                })}
